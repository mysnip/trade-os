...
const de = {
  ...
  accounts: {
    ...
    deleteTradesTitle: "Alle Trades löschen",
    deleteTradesWarning: "Alle Trades dieses Kontos werden dauerhaft gelöscht. Das Konto selbst bleibt bestehen.",
...
const en: Dictionary = {
  ...
  accounts: {
    ...
    deleteTradesTitle: "Delete all trades",
    deleteTradesWarning: "All trades for this account will be permanently deleted. The account itself stays intact.",
